                                                      ...
                                                      <div class="col-md-6">
                                                          <a href="#">
                                                              <div class="short-cut-item">
                                                                  ...
                                                                  <div class="body">
                                                                      <h4>Your Orders</h4>
                                                                      <p>View the previously purchased items</p>
                                                                  </div>
                                                              </div>
                                                          </a>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          <a href="#">
                                                              <div class="short-cut-item">
                                                                  ...
                                                                  <div class="body">
                                                                      <h4>Marketplace</h4>
                                                                      <p>Submit your product to CMS THEME SEEDS's marketplace</p>
                                                                  </div>
                                                              </div>
                                                          </a>
                                                      </div>
                                                      <div class="col-md-6">
                                                          <a href="#">
                                                              <div class="short-cut-item">
                                                                  ...
                                                                  <div class="body">
                                                                      <h4>Apply to become a seller</h4>
                                                                      <p>Get paid by selling your work!</p>
                                                                  </div>
                                                              </div>
                                                          </a>
                                                      </div>
