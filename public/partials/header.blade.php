        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
                    <li><a href="https://twitter.com/#" target="_blank" class="social-icons"><i class="fab fa-twitter"></i></a></li>
                    <li><a href="https://www.facebook.com/#" target="_blank" class="social-icons"><i class="fab fa-facebook"></i></a></li>
                    <li><a href="https://github.com/#" target="_blank" class="social-icons"><i class="fab fa-github"></i></a></li>
    ...
    @endif
    <a href="https://github.com/#" target="_blank" class="github_btn hidden-md hidden-lg"><i class="fab fa-github"></i></a>
</header>
